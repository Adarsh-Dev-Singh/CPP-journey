...
class Fullmetal_Alchemist{// Abstract Base Class : which have atleast one pure virtual function & are not meant  for making objects directly
    protected:
    int main_char;
    string Genre;
    public:
    ...
    virtual void display()=0;//Pure Virtual Function : which must be overwrite in derived class
};
